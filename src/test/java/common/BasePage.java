...
public class BasePage {
	...
	protected void performKeyboardAction(WebDriver driver, String xpathLocator, String action) {
		WebElement element = getWebElement(driver, xpathLocator);
		...
		case "paste":
			...
			break;
		case "cut":
			actions.keyDown(element, Keys.CONTROL).sendKeys("x").keyUp(Keys.CONTROL).perform();
			break;
		case "enter":
	...
	protected void performKeyboardAction(WebDriver driver, String xpathLocator, String action, String... dynamicValues) {
		WebElement element = getWebElement(driver, xpathLocator, dynamicValues);
		switch (action.toLowerCase()) {
		case "copy":
			new Actions(driver).keyDown(element, Keys.CONTROL).sendKeys("c").keyUp(Keys.CONTROL).perform();
			break;
		case "paste":
			new Actions(driver).keyDown(element, Keys.CONTROL).sendKeys("v").keyUp(Keys.CONTROL).perform();
			break;
		case "cut":
			new Actions(driver).keyDown(element, Keys.CONTROL).sendKeys("x").keyUp(Keys.CONTROL).perform();
			break;
		case "enter":
	...
	protected void waitForElementVisible(WebDriver driver, String xpathLocator) {
		...
		scrollElementIntoViewTopByJS(driver, xpathLocator);
	}
	...
	protected void waitForElementVisible(WebDriver driver, String xpathLocator, String... dynamicValues) {
		...
		scrollElementIntoViewTopByJS(driver, xpathLocator, dynamicValues);
	}
	...
	protected void uploadFile(WebDriver driver, String... fileNames) {
		for (String fileName : fileNames) {
			getWebElement(driver, "//input[@type='file']").sendKeys(GlobalConstants.UPLOAD_FILES_FOLDER + fileName);
		}
	}
